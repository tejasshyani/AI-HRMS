...
@Component({
  ...
  template: `
    <div class="p-6 pb-12 space-y-6 max-w-7xl mx-auto">
      ...
      <!-- Loading State -->
      <div *ngIf="isLoading" class="card p-16 text-center border border-slate-200">
        <div class="loading-container">
          <div class="loader-spinner"></div>
          <div class="text-xs font-bold text-slate-700">Rendering master attendance calendar...</div>
          <div class="text-[11px] text-slate-400">Loading biometric punches, leave records, and official holidays for {{ getSelectedEmpName() }}</div>
        </div>
      </div>

      <!-- MONTHLY CALENDAR GRID -->
      <div *ngIf="!isLoading && viewMode === 'monthly'" class="card p-4 sm:p-6 border border-slate-200 overflow-x-auto">
      ...
      <!-- WEEKLY VIEW -->
      <div *ngIf="!isLoading && viewMode === 'weekly'" class="card p-6 border border-slate-200 space-y-4">
      ...
      <div *ngIf="!isLoading && viewMode === 'yearly'" class="card p-6 border border-slate-200">
