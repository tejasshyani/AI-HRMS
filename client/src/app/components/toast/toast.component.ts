...
@Component({
  ...
  template: `
    <div class="fixed top-5 left-1/2 -translate-x-1/2 md:left-5 md:right-auto md:translate-x-0 z-50 flex flex-col gap-2.5 max-w-sm w-[calc(100vw-32px)] md:w-full pointer-events-none px-2 md:px-0">
      <div 
