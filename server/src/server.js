...
// Ultra-lightweight Health Check for Render uptime monitors & keep-alive
...
const startServer = async () => {
  ...
  app.listen(PORT, () => {
    ...
    // Automatic Keep-Alive to prevent Render Free Tier sleep & cold starts (Every 10 mins)
    const https = require('https');
    const keepAliveUrl = process.env.RENDER_EXTERNAL_URL || 'https://fingoal-hrms.onrender.com';
    setInterval(() => {
