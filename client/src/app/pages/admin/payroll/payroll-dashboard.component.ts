              ...
              <tr *ngIf="isLoading">
                <td colspan="10" class="py-16 text-center">
                  <div class="loading-container">
                    ...
                    <div class="text-xs font-bold text-slate-700">Computing real-time payroll breakdown...</div>
                    <div class="text-[11px] text-slate-400">Auditing working days, leaves, and net disbursements</div>
                  </div>
                </td>
              </tr>
