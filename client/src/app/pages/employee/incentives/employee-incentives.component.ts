              ...
              <tr *ngIf="isLoading">
                <td colspan="6" class="py-16 text-center">
                  <div class="loading-container">
                    ...
                    <div class="text-xs font-bold text-slate-700">Loading loan records & commission tiers...</div>
                    <div class="text-[11px] text-slate-400">Fetching personal disbursements and incentive slabs</div>
                  </div>
                </td>
              </tr>
