                ...
                <tr *ngIf="isTableLoading">
                  <td colspan="7" class="py-16 text-center">
                    <div class="loading-container">
                      ...
                      <div class="text-xs font-bold text-slate-700">Loading daily attendance records...</div>
                      <div class="text-[11px] text-slate-400">Fetching check-in, check-out, and status timestamps</div>
                    </div>
                  </td>
                </tr>
