              ...
              <tr *ngIf="isLoading">
                <td colspan="10" class="py-16 text-center">
                  <div class="loading-container">
                    ...
                    <div class="text-xs font-bold text-slate-700">Loading salary slip records...</div>
                    <div class="text-[11px] text-slate-400">Fetching payable days, leave deductions, and net payouts</div>
                  </div>
                </td>
              </tr>
