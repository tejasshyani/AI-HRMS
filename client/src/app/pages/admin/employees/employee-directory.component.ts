              ...
              <tr *ngIf="isLoading">
                <td colspan="6" class="py-16 text-center">
                  <div class="loading-container">
                    ...
                    <div class="text-xs font-bold text-slate-700">Loading employee directory...</div>
                    <div class="text-[11px] text-slate-400">Fetching profiles and compensation structures</div>
                  </div>
                </td>
              </tr>
