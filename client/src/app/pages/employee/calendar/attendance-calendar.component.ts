    ...
    <div class="p-6 pb-12 space-y-6 max-w-7xl mx-auto">
      ...
      <div *ngIf="isLoading" class="card p-16 text-center border border-slate-200">
        <div class="loading-container">
          ...
          <div class="text-xs font-bold text-slate-700">Rendering monthly attendance calendar...</div>
          <div class="text-[11px] text-slate-400">Mapping daily punches, holidays, and Sunday leaves</div>
        </div>
      </div>
