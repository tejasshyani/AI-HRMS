              ...
              <tr *ngIf="isLoading">
                <td colspan="8" class="py-16 text-center">
                  <div class="loading-container">
                    ...
                    <div class="text-xs font-bold text-slate-700">Loading loan disbursements & incentives...</div>
                    <div class="text-[11px] text-slate-400">Auditing sourcing slab calculations and tier commissions</div>
                  </div>
                </td>
              </tr>
